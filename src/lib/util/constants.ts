...
export const BotConnections: Map<string, BotInfo> = new Map([
	...
	['1167655485529403553', { id: '1167655485529403553', name: 'ChairBot', apiHost: 'http://api.joov.sitson.me:35524', redirect: 'https://joov.sitson.me/oauth/register?id=1167655485529403553' }]
]);
