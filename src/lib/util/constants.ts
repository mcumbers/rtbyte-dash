...
export const BotConnections: Map<string, BotInfo> = new Map([
	...
	['1167655485529403553', { id: '1167655485529403553', name: 'ChairBot', apiHost: 'http://localhost:4000', redirect: 'http://localhost:5173/oauth/register?id=1167655485529403553' }]
]);
