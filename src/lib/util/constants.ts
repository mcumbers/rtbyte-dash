...
export const BotConnections: Map<string, BotInfo> = new Map([
	...
	['284970288700194818', { id: '284970288700194818', name: 'stickbot', apiHost: 'https://stickbot.stickman.codes', redirect: 'http://stickbot.stickman.codes/oauth/register?id=284970288700194818' }],
